...
#End Region
    ...
    Public Function addCliente(ByVal xml As String) As DataTable
        Dim dtTmp As New DataTable
        Try
            Using cmd As New SqlCommand()
        ...
        End Try
    End Function
    Public Function buscaCliente(ByVal xml As String) As DataTable
        Dim dtTmp As New DataTable
        Try
            Using cmd As New SqlCommand()
                ...
                cmd.Connection = objConexion.conectar
                cmd.CommandTimeout = 0
                cmd.Parameters.Add("@numero", SqlDbType.VarChar).Value = xml
